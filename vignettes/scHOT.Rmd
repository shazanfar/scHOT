...
<!-- sce = SingleCellExperiment::SingleCellExperiment(assays = S4Vectors::SimpleList(counts = SKCM)) -->
...
<!-- STRING_subset <- STRING[sample(nrow(STRING), 30),] -->
<!-- scHOT = scHOT_addTestingScaffold(scHOT, STRING_subset) -->
<!-- scHOT@testingScaffold -->



<!-- colData(scHOT)[,"traj"] <- c(rep(1, 100), rep(2, 70), rep(3, 50)) -->

<!-- plotColouredExpression(scHOT, c("SKP1", "SKP2"), "traj", n = 2) -->

<!-- plotColouredExpression(scHOT, c("SKP1", "SKP2"), NULL, n = 3) -->


<!-- plotOrderedExpression(scHOT, c("SKP1", "SKP2"), branches = "traj", facet = "branch") -->
<!-- plotOrderedExpression(scHOT, c("SKP1", "SKP2"), facet = FALSE) -->
...
<!-- SKCM_graph = graph.edgelist(STRING_subset, directed = FALSE) -->
<!-- plotEgoNetwork(scHOT, hubnode = c("MCM5"), network = SKCM_graph) -->
<!-- ``` -->
